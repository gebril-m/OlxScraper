			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
					<div class="right-actions">
						<a href="{{route('tabs.create')}}" class="btn btn-primary float-right" data-toggle="tooltip" data-placement="left" title="Create Tab">
							create new
						</a>
					</div>
				</div>
					...
					<div class="card-body">
						<table id="basicExample" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									<td>{{$tab->name}}</td>
									<td><a href="{{route('tabs.edit',$tab->id)}}" style="color: blue"><span class="icon-eye"></span></a></td>
